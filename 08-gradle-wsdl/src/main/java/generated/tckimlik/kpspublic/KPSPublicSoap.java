...
public interface KPSPublicSoap {
    ...
    @RequestWrapper(localName = "TCKimlikNoDogrula", targetNamespace = "http://tckimlik.nvi.gov.tr/WS", className = "generated.tckimlik.kpspublic.TCKimlikNoDogrula")
    @ResponseWrapper(localName = "TCKimlikNoDogrulaResponse", targetNamespace = "http://tckimlik.nvi.gov.tr/WS", className = "generated.tckimlik.kpspublic.TCKimlikNoDogrulaResponse")
